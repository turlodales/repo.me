...
update_repo() {
    cd "$(dirname "$0")" || exit
    rm -f Packages Packages.xz Packages.gz Packages.bz2 Packages.zst Release Release.gpg 2> /dev/null
    ...
    apt-ftparchive contents ./debians > Contents-iphoneos-arm
...
install_packages() {
    ...
    packages=(apt-utils gnupg xz-utils zstd bzip2 lz4)
...
install_brew_packages() {
    ...
    brew_packages=(gnupg wget xz zstd bzip2 lz4)
